...
public class ShowDynamicsCommand implements Command {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws ServiceException {
        ...
        Map<String, Integer> american2017 = service.getAmericanMoviesAmountOfGenresByYear(popularGenres, YEAR_2017);
        Map<String, Integer> american2018 = service.getAmericanMoviesAmountOfGenresByYear(popularGenres, YEAR_2018);
        Map<String, Integer> american2019 = service.getAmericanMoviesAmountOfGenresByYear(popularGenres, YEAR_2019);
        ...
        Map<String, Integer> chinese2017 = service.getChineseMoviesAmountOfGenresByYear(popularGenres, YEAR_2017);
        Map<String, Integer> chinese2018 = service.getChineseMoviesAmountOfGenresByYear(popularGenres, YEAR_2018);
        Map<String, Integer> chinese2019 = service.getChineseMoviesAmountOfGenresByYear(popularGenres, YEAR_2019);
